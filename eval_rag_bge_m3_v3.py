...
OUTPUT_FILE = "/root/IR/submission_bge_m3_sota_v3.csv"
...
사용자의 질문과 3개의 검색 결과(Candidate)가 주어집니다. 
질문에 가장 정확하고 직접적인 답변을 포함하고 있는 문서를 하나만 골라주세요.
...
with open(OUTPUT_FILE, "w", encoding="utf-8") as f:
    for i, entry in enumerate(tqdm(eval_data)):
        ...
        if candidate_indices:
            ...
            best_idx_in_top3 = rerank_with_llm(rerank_query, top3_candidates)
            
            if best_idx_in_top3 > 0:
