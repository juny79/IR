# Full Config Report (20251224_194959)
...
- Gemini chat ping: ❌ NotFound: 404 models/gemini-3.0-flash-preview is not found for API version v1beta, or is not supported for generateContent. Call ListModels to see the list of available models and their supported methods.
